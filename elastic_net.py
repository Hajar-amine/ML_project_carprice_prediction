# ==========================================================
# Machine Learning - Préprocessing + ElasticNet
# Conforme au rapport
# ==========================================================
...
print("\n==============================")
print("RÉSULTATS - ELASTICNET")
print("==============================")

print(f"MAE  : {mae:.2f} €")
print(f"RMSE : {rmse:.2f} €")
print(f"R²   : {r2:.3f}")
print("\nPréprocessing + ElasticNet terminés avec succès !")
