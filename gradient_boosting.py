# ==========================================================
# Machine Learning - Préprocessing + GradientBoosting
# Conforme au rapport
# ==========================================================
...
# ==========================================================
# Pipeline complet + GradientBoosting
# ==========================================================
...
print("\nEntraînement du GradientBoosting...")
...
print("\n==============================")
print("RÉSULTATS - GRADIENTBOOSTING")
print("==============================")

print(f"MAE  : {mae:.2f} €")
print(f"RMSE : {rmse:.2f} €")
print(f"R²   : {r2:.3f}")
print("\nPréprocessing + GradientBoosting terminés avec succès !")
