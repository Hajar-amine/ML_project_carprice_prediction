# ==========================================================
# Machine Learning - Préprocessing + ExtraTrees
# Conforme au rapport
# ==========================================================
...
print("\n==============================")
print("RÉSULTATS - EXTRATREES")
print("==============================")

print(f"MAE  : {mae:.2f} €")
print(f"RMSE : {rmse:.2f} €")
print(f"R²   : {r2:.3f}")
print("\nPréprocessing + ExtraTrees terminés avec succès !")
